...
<head>
	<meta charset="utf-8">
	<title>KARTABYA'S PROJECT</title>
...
<body class="landing">
	...
	?>
			<section id="banner">
				...
				<p>Quick Search <br> Online Bookings <br> Pay Online <br> Hassle Free Bus Booking<br>Brought To You By kartabya and co</p>
				<ul class="actions">
					<li>
			...
			<a name="about"></a>
			<section id="one" class="wrapper style1 align-centerr">
				<div class="container">
					<header>
			...
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					<header>
						<h2>BookMyBusTicket</h2>
						<p>Book, Travel, Enjoy & Make Memories</p>
					</header>
					<div class="row">
