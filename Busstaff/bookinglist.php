...
$sel="SELECT * FROM booking INNER JOIN bus_schedule ON booking.Id=bus_schedule.Id INNER JOIN bus_registeration ON bus_registeration.bid=bus_schedule.bid INNER JOIN bus_owner ON bus_owner.oid=bus_registeration.oid INNER JOIN user ON booking.UserId=user.UserID WHERE bus_owner.oid='$oid'";
